...
export function TrafficProblemSection() {
  ...
  return (
    <section className="py-18 md:py-32 bg-neutral-950 text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-16 text-center space-y-6">
            ...
            <motion.p 
              ...
              className="text-lg text-neutral-300 leading-relaxed max-w-2xl mx-auto font-helvica"
            >
          ...
          >
            <div className="absolute inset-0 bg-brand/5 blur-3xl" />
            ...
            <p className="relative z-10 text-xl text-neutral-300 mt-4">
